          ...
          <form class="w-full" action="{{ route('admin.items.store') }}" method="post" encitem="multipart/form-data">
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <div class="mt-2 text-sm text-gray-500">
                  Brand items. Contoh: Porche Wajib diisi.
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <div class="mt-2 text-sm text-gray-500">
                  Brand items. Contoh: Family Car Wajib diisi.
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <div class="mt-2 text-sm text-gray-500">
                  Fitur Items. Contoh: Fitur 1, Fitur 2, Fitur 3, dsb. Dipisahkan dengan koma (,)
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <div class="mt-2 text-sm text-gray-500">
                  Foto Items. Lebih dari satu foto dapat di upload. optional.
                </div>
              </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-3 px-3 mt-4 mb-6 -mx-3">
                <div class="w-full">
                  ...
                  <div class="mt-2 text-sm text-gray-500">
                    Harga Items. Angka. Contoh: 1000000. Wajib diisi.
                  </div>
                </div>
                <div class="w-full">
                  <label class="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase" for="grid-last-name">
                  ...
                  <input value="{{ old('star') }}" name="star"
                         class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                         id="grid-last-name" type="number" placeholder="Rating" max="5" min="1" step=".01">
                  <div class="mt-2 text-sm text-gray-500">
                    Rating Items. Angka. Contoh: 5. Optional.
                  </div>
                </div>
                <div class="w-full">
                  <label class="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase" for="grid-last-name">
